...
Ejemplos de uso:
  ...
  %(prog)s impares.pdf pares.pdf -o resultado.pdf --interleave --reverse-pdfs 1 \\
    ...
    parser.add_argument('--reverse-pdfs', type=int, nargs='+', metavar='INDEX',
                       help='Índices de PDFs a invertir (0-based). Ej: --reverse-pdfs 1 2')
    
    # Profile
    parser.add_argument('--profile', choices=['document', 'photo', 'ebook', 'archive', 'share', 'fast'],
                       help='Usar perfil de configuración predefinido')
    
    # OCR
    parser.add_argument('--ocr', action='store_true',
                       help='Añadir capa de texto OCR')
    parser.add_argument('--ocr-lang', default='spa',
                       help='Idioma para OCR (spa, eng, etc.)')
    
    # Deskew
    parser.add_argument('--deskew', action='store_true',
                       help='Enderezar páginas (rotación básica)')
    parser.add_argument('--auto-deskew', action='store_true',
    ...
    parser.add_argument('--enhance', action='store_true',
                       help='Mejorar contraste y brillo')
    parser.add_argument('--denoise', action='store_true',
                       help='Eliminar ruido')
    parser.add_argument('--binarize', action='store_true',
                       help='Convertir a blanco y negro')
    parser.add_argument('--sharpen', action='store_true',
                       help='Mejorar nitidez')
    parser.add_argument('--despeckle', action='store_true',
                       help='Eliminar manchas')
    parser.add_argument('--autocrop', action='store_true',
                       help='Recortar bordes blancos')
    parser.add_argument('--max-dpi', type=int,
                       help='DPI máximo (reducir para menor tamaño)')
    
    # Blank pages
    parser.add_argument('--remove-blank', action='store_true',
                       help='Eliminar páginas en blanco')
    parser.add_argument('--blank-threshold', type=float, default=0.99,
                       help='Umbral de blancura (0-1)')
    
    # Optimization
    parser.add_argument('--optimize', action='store_true',
                       help='Optimizar y comprimir PDF')
    parser.add_argument('--compress-level', type=int, default=5, choices=range(0, 10),
    ...
    parser.add_argument('--lossy-dpi', type=int, default=150,
                       help='DPI objetivo para re-render (recomendado 100-200)')
    parser.add_argument('--lossy-quality', type=int, default=70,
    ...
    parser.add_argument('--watermark-rotation', type=int, default=45,
                       help='Rotación de marca de agua (grados)')
    
    # Page numbers
    parser.add_argument('--page-numbers', action='store_true',
                       help='Añadir números de página')
    parser.add_argument('--page-number-position', default='bottom-center',
                       choices=['bottom-center', 'bottom-right', 'bottom-left',
                               'top-center', 'top-right', 'top-left'],
                       help='Posición de números de página')
    parser.add_argument('--page-number-size', type=int, default=10,
                       help='Tamaño de fuente de números')
    parser.add_argument('--page-number-margin', type=int, default=20,
                       help='Margen desde el borde')
