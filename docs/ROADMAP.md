...
```bash
python cli.py impares.pdf pares.pdf -o salida.pdf --interleave \
  --reverse-pdfs 1 --ocr --ocr-lang spa
```
...
1. Detección de páginas en blanco
2. Detección automática de orden
...
1. Marca de agua y metadata
2. Bookmarks automáticos
3. GUI
4. Validación y reparación
