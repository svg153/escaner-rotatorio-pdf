...
def add_metadata(input_pdf: str, output_pdf: str,
...
def create_watermark_page(text: str, page_size: tuple = A4,
                         opacity: float = 0.3,
                         font_size: int = 60,
                         rotation: int = 45) -> bytes:
    """
...
def add_text_watermark(input_pdf: str, output_pdf: str,
                      watermark_text: str,
                      opacity: float = 0.3,
                      font_size: int = 60,
                      rotation: int = 45,
...
def add_page_numbers(input_pdf: str, output_pdf: str,
