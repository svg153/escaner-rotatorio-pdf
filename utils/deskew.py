...
def auto_deskew_image(image: 'Image.Image', 
                     threshold: float = 0.5,
                     verbose: bool = False) -> Tuple['Image.Image', float]:
    """
...
def auto_deskew_pdf(input_pdf: str, output_pdf: str, 
                   threshold: float = 0.5,
    ...
    try:
        ...
        for i, img in enumerate(images, 1):
            ...
            corrected, angle = auto_deskew_image(img, threshold=threshold, verbose=verbose)
